...
Ультралегковесный headless-клиент для **Яндекс Музыки**, написанный на Rust. Играет исключительно поток **«Моя волна»**, не тащит за собой Electron/Chromium, нативно интегрируется в окружение через **MPRIS v2** и управляется стандартными системными средствами (`playerctl`, Waybar, виджеты панелей, медиаклавиши).
...
* **Zero-bloat:** потребление памяти в пределах **15–20 МБ RSS** (против ~700 МБ у официального десктопного приложения).
...
Добавьте вызов бинарника в конфигурационный файл вашего оконного менеджера или композитора:
